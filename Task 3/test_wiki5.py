...
def search_wiki(query):
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'SavoriaBot/9.0'})
    try:
...
search_wiki('Paneer tikka masala')
search_wiki('Cheeseburger')
search_wiki('Bacon cheeseburger')
search_wiki('Paneer makhani')
